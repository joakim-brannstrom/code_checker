...
shared static this() {
    ...
    "alpha.cplusplus.EnumCastOutOfRange":                         Severity.medium,
    ...
    "alpha.security.MmapWriteExec":                               Severity.medium,
    ...
    "bugprone-branch-clone":                                      Severity.low,
    "bugprone-copy-constructor-init":                             Severity.medium,
    "bugprone-dangling-handle":                                   Severity.high,
    "bugprone-exception-escape":                                  Severity.medium,
    "bugprone-fold-init-type":                                    Severity.high,
    "bugprone-forward-declaration-namespace":                     Severity.low,
    "bugprone-forwarding-reference-overload":                     Severity.low,
    "bugprone-inaccurate-erase":                                  Severity.high,
    "bugprone-incorrect-roundings":                               Severity.high,
    "bugprone-integer-division":                                  Severity.medium,
    "bugprone-lambda-function-name":                              Severity.low,
    "bugprone-macro-parentheses":                                 Severity.medium,
    "bugprone-macro-repeated-side-effects":                       Severity.medium,
    "bugprone-misplaced-operator-in-strlen-in-alloc":             Severity.medium,
    "bugprone-misplaced-widening-cast":                           Severity.high,
    "bugprone-move-forwarding-reference":                         Severity.medium,
    "bugprone-multiple-statement-macro":                          Severity.medium,
    "bugprone-narrowing-conversions":                             Severity.medium,
    "bugprone-parent-virtual-call":                               Severity.medium,
    "bugprone-sizeof-container":                                  Severity.high,
    "bugprone-sizeof-expression":                                 Severity.high,
    "bugprone-string-constructor":                                Severity.high,
    "bugprone-string-integer-assignment":                         Severity.low,
    "bugprone-string-literal-with-embedded-nul":                  Severity.medium,
    "bugprone-suspicious-enum-usage":                             Severity.high,
    "bugprone-suspicious-memset-usage":                           Severity.high,
    "bugprone-suspicious-missing-comma":                          Severity.high,
    "bugprone-suspicious-semicolon":                              Severity.high,
    "bugprone-suspicious-string-compare":                         Severity.medium,
    "bugprone-swapped-arguments":                                 Severity.high,
    "bugprone-terminating-continue":                              Severity.medium,
    "bugprone-throw-keyword-missing":                             Severity.medium,
    "bugprone-too-small-loop-variable":                           Severity.medium,
    "bugprone-undefined-memory-manipulation":                     Severity.medium,
    "bugprone-undelegated-constructor":                           Severity.medium,
    "bugprone-unused-raii":                                       Severity.high,
    "bugprone-unused-return-value":                               Severity.medium,
    "bugprone-use-after-move":                                    Severity.high,
    "bugprone-virtual-near-miss":                                 Severity.medium,
    "cert-dcl03-c":                                               Severity.medium,
    "cert-dcl16-c":                                               Severity.style,
    ...
    "cert-msc32-c":                                               Severity.medium,
    "cert-msc50-cpp":                                             Severity.low,
    "cert-msc51-cpp":                                             Severity.medium,
    ...
    "cplusplus.InnerPointer":                                     Severity.high,
    "cplusplus.Move":                                             Severity.medium,
    "cplusplus.NewDelete":                                        Severity.high,
    "cplusplus.NewDeleteLeaks":                                   Severity.high,
    "cplusplus.SelfAssignment":                                   Severity.medium,
	"cppcoreguidelines-avoid-c-arrays":                           Severity.low,
    "cppcoreguidelines-avoid-goto":                               Severity.style,
    "cppcoreguidelines-avoid-magic-numbers":                      Severity.style,
    "cppcoreguidelines-c-copy-assignment-signature":              Severity.medium,
    "cppcoreguidelines-explicit-virtual-functions":               Severity.low,
    "cppcoreguidelines-interfaces-global-init":                   Severity.low,
    "cppcoreguidelines-macro-usage":                              Severity.low,
    "cppcoreguidelines-narrowing-conversions":                    Severity.medium,
    "cppcoreguidelines-no-malloc":                                Severity.low,
    "cppcoreguidelines-non-private-member-variables-in-classes":  Severity.low,
    "cppcoreguidelines-owning-memory":                            Severity.style,
    ...
    "google-readability-avoid-underscore-in-googletest-name":     Severity.style,
    ...
    "google-runtime-references":                                  Severity.style,
	"hicpp-avoid-goto":                                           Severity.style,
    ...
    "hicpp-multiway-paths-covered":                               Severity.style,
    ...
    "hicpp-uppercase-literal-suffix":                             Severity.style,
    ...
    "misc-non-private-member-variables-in-classes":               Severity.low,
    ...
    "modernize-avoid-c-arrays":                                   Severity.low,
    "modernize-concat-nested-namespaces":                         Severity.style,
    "modernize-deprecated-headers":                               Severity.low,
    "modernize-deprecated-ios-base-aliases":                      Severity.low,
    ...
    "modernize-use-nodiscard":                                    Severity.low,
    "modernize-use-override":                                     Severity.low,
    "modernize-use-trailing-return-type":                         Severity.style,
    "modernize-use-transparent-functors":                         Severity.low,
    "modernize-use-uncaught-exceptions":                          Severity.style,
    ...
    "readability-isolate-declaration":                            Severity.style,
    "readability-magic-numbers":                                  Severity.style,
    ...
    "readability-redundant-preprocessor":                         Severity.style,
    ...
    "readability-simplify-subscript-expr":                        Severity.style,
    ...
    "readability-string-compare":                                 Severity.low,
    "readability-uniqueptr-delete-release":                       Severity.style,
    "readability-uppercase-literal-suffix":                       Severity.style,
    "clang-analyzer-security.FloatLoopCounter":                   Severity.medium,
    "clang-analyzer-security.insecureAPI.bcmp":                   Severity.low,
    "clang-analyzer-security.insecureAPI.bcopy":                  Severity.low,
    "clang-analyzer-security.insecureAPI.bzero":                  Severity.low,
