...
auto getOptions(string[] args) {
    ...
    getopt(args, "single|s", &single, //single-threaded
            "debug|d", &debugOutput, //print debug output
            "esccodes|e",
            &forceEscCodes, "help|h", &help, "list|l", &list, "random|r", &random,
            "seed", &seed, "trace|t", &stackTraces, "chrono|c", &showChrono,);
    ...
    return Options(!single, args[1 .. $], debugOutput, list, exit,
            forceEscCodes, random, seed, stackTraces, showChrono);
}
