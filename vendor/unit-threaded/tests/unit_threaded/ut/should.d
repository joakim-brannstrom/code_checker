...
@safe pure unittest {
    ...
    class CustomException : Exception {
        this(string msg = "", in string file = __FILE__, in size_t line = __LINE__) {
            super(msg, file, line);
        }
    }

    void func() {
        throw new CustomException("oh noes");
    }
...
@safe pure unittest {
    ...
    assertExceptionMsg(1.should == 2, `    tests/unit_threaded/ut/should.d:123 - Expected: 2`
...
@safe pure unittest {
    ...
    assertExceptionMsg(1.should.be == 2, `    tests/unit_threaded/ut/should.d:123 - Expected: 2`
            ~ "\n" ~ `    tests/unit_threaded/ut/should.d:123 -      Got: 1`);
}
