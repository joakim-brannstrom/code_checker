...
private class Class {
    ...
    final int timesTwo(int i) @safe pure nothrow const {
        return i * 2;
    }

    int timesThree(int i) @safe pure nothrow const {
        return i * 3;
    }

    int timesThreeMutable(int i) @safe pure nothrow {
        return i * 3;
    }
}
...
@safe pure unittest {
    ...
    int i;
    assertExceptionMsg(i = m.foo, "    tests/unit_threaded/ut/mock.d:123 - foo was called");
    assertExceptionMsg(i = m.bar, "    tests/unit_threaded/ut/mock.d:123 - bar was called");
}
